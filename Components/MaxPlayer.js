        ...
        <Animated.View style={[details, { opacity: aIcons }]}>
          <View style={maxPlayerDetails}>
            ...
            <View style={styles.titleView}>
              <MaterialCommunityIcons
                name="format-title"
                color={Colors.max_player_details_mini_icons}
                size={thirteen}
              />
              <Text
                numberOfLines={1}
                ...
                style={{
                  paddingBottom: three,
                  color: Colors.max_player_details_title_text,
                  fontSize: fifteen,
                }}
              >
            ...
            <View style={styles.titleView}>
              ...
              <Text
                ...
                ellipsizeMode="clip"
                style={{
                  color: Colors.max_player_details_composer_text,
                  fontSize: eleven,
                }}
              >
            ...
            <View style={maxIconsBottom}>
              <View style={maxIconsBottomEach}>
                <TouchableOpacity
                  ...
                  onPress={previous}
                >
                  <Feather name="skip-back" size={thirty} color="#ffffff" />
                </TouchableOpacity>
              </View>
              <View style={maxIconsBottomEach}>
                {/**PLAYER CONTROLS */}
              ...
              <View style={maxIconsBottomEach}>
                <TouchableOpacity
                  ...
                  onPress={toNext}
                >
                  <Feather name="skip-forward" size={thirty} color="#ffffff" />
                </TouchableOpacity>
              </View>
            </View>
          </View>

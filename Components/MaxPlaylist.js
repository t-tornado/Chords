...
import { useCloseQueue, useDownloadedSongs, usePlayerLoadedState, useQueueState } from '../Context/TarckContext'
...
React.useEffect(()=> {
    ...
    return (
        ...
        >songs: {downloadedSongs.length }</Text>
                </View>
            </View>

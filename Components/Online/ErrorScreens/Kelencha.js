...
const KelenchaErrorScreen = ({
  ...
  if(!loadingError) {
    ...
    return (
      <View style={modal}>
      <Text style={textt} >Error Loading Kelencha</Text>
    <TouchableOpacity style={errorContainer} onPress={onFetchKelencha} >
...
export default KelenchaErrorScreen
...
import { getEasterAnthems, getLoadingEasterAnthems, getErrorLoadingEasterAnthems} from '../../../Redux/Selectors/PlaySelector'
...
const mapStateToProps = (state) => {
  return {
    ...
    errorLoadingEasterAnthems: getErrorLoadingEasterAnthems(state.easterAnthems)
  }
}
